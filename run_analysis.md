...
**load the activity\_labels.txt file which include all the labels of the activity categories.and assign those labels to the "activity" column of "Data" by using factor function**
